        ...
        <div className="container mx-auto bg-white dark:bg-gray-900 p-6 rounded-lg shadow-lg">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="bg-green-100 dark:bg-green-700 p-4 rounded-lg shadow-lg text-center">
              <img src="/ods13.png" alt="ODS 13" className="mx-auto mb-4 w-[100px] h-[100px]" />
            ...
            <div className="bg-green-100 dark:bg-green-700 p-4 rounded-lg shadow-lg text-center">
              <img src="/ods15.png" alt="ODS 15" className="mx-auto mb-4 w-[100px] h-[100px]" />
            ...
            <div className="bg-green-100 dark:bg-green-700 p-4 rounded-lg shadow-lg text-center">
              <img src="/ods17.png" alt="ODS 17" className="mx-auto mb-4 w-[100px] h-[100px]" />
